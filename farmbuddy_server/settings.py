"""
Django settings for farmbuddy_server project.
...
SECRET_KEY = '_cp1vc+@1g$)&!af&ldk6__zjc0jdybodpl7t-@565)60u6t(5'
...
ROOT_URLCONF = 'farmbuddy_server.urls'
...
WSGI_APPLICATION = 'farmbuddy_server.wsgi.application'
